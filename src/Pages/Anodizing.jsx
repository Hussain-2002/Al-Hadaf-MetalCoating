...
export default function Anodizing() {
  ...
  const images = Array.from({ length: 12 }).map((_, i) => `/assets/gallery/anodize-${i + 1}.jpg`);
  const videos = Array.from({ length: 6 }).map((_, i) => `/assets/videos/anodize-${i + 1}.mp4`);
    ...
    <div className="min-h-screen bg-[#ffffff] text-white overflow-x-hidden">
      ...
      <main className="pt-40 pb-12 px-4 text-center relative">
        ...
        <p className="text-gray-800 mb-12 max-w-2xl mx-auto">
          <T>Elegant. Enduring. Electrified — anodizing done right.</T>
        </p>
