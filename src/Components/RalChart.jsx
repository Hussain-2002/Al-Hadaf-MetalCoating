// src/Pages/RALChart.jsx
import React, { useState, useRef, useEffect } from "react";
import Header from "@/Components/Header";
import Footer from "@/Components/Footer";

const RAL_PALETTE = [
  // Yellows & Beiges (1000 series)
  ...
  { code: "RAL 5024", hex: "#5D9B9B", name: "Patina Green" },
...
export default function RALChart() {
  const [color, setColor] = useState(RAL_PALETTE[5].hex);
  const [selectedRal, setSelectedRal] = useState(RAL_PALETTE[5].code);
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
              ...
              <div className="space-y-4">
                <label className="block text-sm font-medium text-gray-700">Choose RAL</label>
                <select
                  value={selectedRal}
                  onChange={handleRalChange}
                  className="w-full rounded-md border px-3 py-2 bg-white"
                >
                  <option value="">-- Select a RAL code (or use color picker) --</option>
                  {RAL_PALETTE.map((r) => (
                ...
                <p className="mt-3 text-sm text-gray-600">
                  Tip: Drag the cube to rotate or use sliders. Choose a RAL or paste a hex code.
                </p>
              </div>
              ...
              <div className="md:col-span-2 flex flex-col items-center">
                <div
                  ...
                  style={{
                    minHeight: Math.max(320, size * 1.6),
                    padding: 12,
                    cursor: "grab",
                  }}
                >
                  <div
                    style={{
                      perspective: 1000,
                      width: Math.min(720, size * 2),
                      height: Math.max(320, size * 1.6),
                      display: "flex",
