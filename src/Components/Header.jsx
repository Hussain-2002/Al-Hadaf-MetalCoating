...
function Header() {
  ...
  const navItems = [
    ...
    { name: "Contact Us", href: "/contact" }, // ✅ updated
  ]
    ...
    <header className="fixed top-0 left-0 w-full z-50">
      ...
      <div
        className={`relative w-full transition-all duration-400 
          ${isScrolled ? "bg-yellow-500 text-black" : "bg-white/70 text-black"}`}
      >
        {/* ✅ Desktop Layout */}
        ...
        <div className="hidden md:flex items-center justify-between px-8 py-4">
          ...
          <div className="flex items-center">
            <img
              src="assets/logo.png"
              alt="Logo"
              className="h-20 w-auto" // ✅ slightly bigger logo
            />
          </div>
          ...
          <div className="flex items-center">
            <Link
              to="/contact"
              className="px-6 py-2.5 rounded-md bg-yellow-500 text-white font-semibold text-sm md:text-base hover:bg-yellow-600 transition shadow-sm"
            >
              Enquire Now
            </Link>
          </div>
          ...
          <Drawer>
            ...
            <DrawerContent className="bg-white p-6">
              ...
              <div className="mt-6 border-t pt-4">
                <Link
                  to="/contact"
                  className="w-full block text-center px-6 py-2.5 rounded-md bg-yellow-500 text-white font-semibold text-base hover:bg-yellow-600 transition shadow-sm"
                >
                  Enquire Now
                </Link>
              </div>
